...
const GEO_POINTS: IncrementalityGeoPoint[] = [
  ...
  { label: "Birmingham", x: 34, y: 30, group: "treatment" },
  { label: "Glasgow", x: 18, y: 10, group: "control" },
  { label: "Edinburgh", x: 24, y: 12, group: "treatment" },
  { label: "Norwich", x: 62, y: 28, group: "control" },
  { label: "Cardiff", x: 18, y: 34, group: "treatment" },
];
...
export const INCREMENTALITY_EXPERIMENTS: IncrementalityExperiment[] = [
  createExperiment({
    ...
    summary: "Validated geo lift across the UK summer market and established the strongest incremental efficiency signal in the current portfolio.",
    country: "United Kingdom",
    scopeLabel: "Google PMAX · UK",
    ...
    impactedEntities: ["UK_Demand_Gen", "UK_Performance_Max", "UK_search_generic"],
    campaigns: ["UK_Demand_Gen", "UK_Performance_Max", "UK_search_generic"],
  ...
  createExperiment({
    ...
    name: "Promo Forecast Lift – Manchester",
    application: "demand",
    template: "geo_lift",
    domainLens: "demand",
    status: "running",
    ...
    country: "United Kingdom",
    scopeLabel: "Manchester chilled promo demand",
    ...
    impactedEntities: ["Manchester DC", "Chilled promo categories", "Weekend uplift model"],
    campaigns: ["SUMMER_BOGO_CAMPAIGN"],
    treatmentDesign: "Promo-aware forecast applied to treated categories in Manchester.",

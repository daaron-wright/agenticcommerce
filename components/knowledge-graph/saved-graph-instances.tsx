...
const DOMAIN_BADGE_STYLES = {
  udp: "border-slate-200 bg-slate-50 text-slate-700",
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="text-[10px] text-slate-400">Updated {timeAgo(instance.updatedAt)}</span>
          </div>
          <p className="mt-2 text-sm font-semibold text-slate-900">{instance.title}</p>
          <p className="mt-1 text-[11px] leading-snug text-slate-500">{instance.description || "No description provided."}</p>
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-2">
          <Button asChild size="sm" className="rounded-full bg-slate-900 px-3 text-[11px] hover:bg-slate-950">
    ...
    <Card className="border border-slate-200 bg-white/95 shadow-none">
      <CardHeader>
        <div className="flex items-start justify-between gap-3">
          <div>
            <CardTitle className="text-base font-semibold text-slate-900">Saved Graphs</CardTitle>
      ...
      <CardContent className="space-y-3">
        {!isHydrated ? (
          <div className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-6 text-sm text-slate-500">
          ...
          <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50/70 px-4 py-6 text-center">
            <Network className="mx-auto h-6 w-6 text-slate-400" />
            <p className="mt-2 text-sm font-semibold text-slate-900">No saved graph workspaces yet</p>
      ...
      <Card className="border border-slate-200 bg-white/95 shadow-none">
        <CardContent className="flex flex-col gap-4 p-5 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button className="rounded-full bg-slate-900 hover:bg-slate-950" onClick={onCreateRequest}>
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <Card className="border border-slate-200 bg-white/95 shadow-none">
          <CardContent className="p-4">
            ...
            <p className="mt-2 text-2xl font-semibold text-slate-900">{visibleInstances.length}</p>
          </CardContent>
        </Card>
        <Card className="border border-slate-200 bg-white/95 shadow-none">
          <CardContent className="p-4">
      ...
      <div className="space-y-3">
        {!isHydrated ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50/70 px-4 py-8 text-center">
            <Network className="mx-auto h-6 w-6 text-slate-400" />
            <p className="mt-2 text-sm font-semibold text-slate-900">No saved graph workspaces</p>
            <p className="mt-1 text-[11px] text-slate-500">

...
function SettingsSnapshot() {
  return (
    <div className="space-y-1.5">
      <div className="flex items-center justify-between text-xs px-2 py-1.5 bg-stone-50 rounded">
      ...
      <CardContent className="p-0">
        ...
        <div className="grid grid-cols-2 gap-3 p-4">
          <div className="text-center p-3 bg-red-50/30 rounded-lg border border-red-100">
            <p className="text-[10px] text-stone-500 font-medium">Single Loss Expectancy</p>
            <p className="text-xl font-bold text-red-700 mt-1">{fmtCurrency(svc.sle)}</p>
            <p className="text-[10px] text-stone-500 mt-0.5">Cost of one major cyber event</p>
          </div>
          <div className="text-center p-3 bg-amber-50/30 rounded-lg border border-amber-100">
            <p className="text-[10px] text-stone-500 font-medium">Annualised Loss Expectancy</p>
            <p className="text-xl font-bold text-amber-700 mt-1">{fmtCurrency(svc.ale)}</p>
            <p className="text-[10px] text-stone-500 mt-0.5">Expected annual cyber loss</p>
          </div>
        </div>

        {/* Calculation breakdown */}
        <div className="px-4 pb-3">
          <p className="text-[10px] font-semibold text-stone-500 uppercase tracking-wider mb-2">Calculation</p>
          <div className="grid grid-cols-4 gap-2">
            ...
            <div className="text-center p-2 bg-stone-50 rounded-md">
              ...
              <p className="text-[10px] text-stone-500 font-medium">Annual probability</p>
            </div>
            <div className="text-center p-2 bg-stone-50 rounded-md">
              ...
              <p className="text-[10px] text-stone-500 font-medium">Business loss</p>
            </div>
            <div className="text-center p-2 bg-stone-50 rounded-md">
              <p className="text-[10px] text-muted-foreground">MTCR</p>
              <p className="text-xs font-bold mt-0.5">{svc.controlInputs.mtcrHours}h</p>
              <p className="text-[10px] text-stone-500 font-medium">{mtcrDays} days recovery</p>
            </div>
          </div>
        </div>

        <div className="flex items-center justify-between px-3 py-2 border-t bg-stone-50/50">
      ...
      <CardContent className="p-0">
        <div className="flex items-center justify-between px-3 py-2 border-b bg-stone-50/50">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-stone-700">Industry Benchmark Comparison</span>
          </div>
          ...
          <div className="space-y-2">
            {benchmarkData.map((item) => (
              <div key={item.name} className="flex items-center gap-3">
                <span className="text-[10px] text-stone-600 font-medium w-20 shrink-0">{item.name}</span>
                ...
                <span className="text-[10px] font-semibold text-stone-700 w-8 text-right">{item.score}</span>
              </div>
            ))}
          </div>
      ...
      <CardContent className="p-0">
        <div className="flex items-center justify-between px-3 py-2 border-b bg-stone-50/50">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-stone-700">Attack Anatomy — Before vs After</span>
          </div>
        </div>
          ...
          <div className="p-3">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between text-[10px]">
                <span className="text-stone-600">Blast Radius</span>
              ...
              <div className="flex items-center justify-between text-[10px]">
                <span className="text-stone-600">Detection Time</span>
                <span className="font-semibold text-red-600">{DEFAULT_BENCHMARK.avgMTTI}h</span>
              </div>
              <div className="flex items-center justify-between text-[10px]">
                <span className="text-stone-600">Recovery Time</span>
              ...
              <div className="flex items-center justify-between text-[10px] pt-1.5 border-t border-red-100">
                <span className="text-stone-600 font-medium">Total Impact</span>

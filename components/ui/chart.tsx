...
import { visualizationPalette } from "@/lib/visualization-theme"
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-[14px] border px-2.5 py-1.5 text-xs shadow-xl",
          className
        )}
        style={{
          borderColor: visualizationPalette.grid,
